...
export function AnimatedGradient({
    ...
    void main() {
      gl_Position = a_position;
            ...
            // Hareket azaltma tercihi acikken donmek yerine tek kare cizilir.
            ...
            const resize = () => {
                ...
                // Boyut degisimi tuvali temizler; dongu yoksa elle yeniden cizilmeli.
            ...
            // Sekme arka plandayken GPU'yu bosuna calistirmayalim: uygulama uzun
            // oyun oturumlari boyunca acik kaliyor, pil farki gercek.
            const onVisibilityChange = () => {
                if (document.hidden) {
                    ...
                    // Duraklama suresi baslangica eklenir; yoksa animasyon zipllar.
                    if (hiddenAtRef.current !== undefined) {
